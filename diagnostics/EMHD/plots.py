...
def plot_SF2(SF2b, SF2u, lpar, lper, xlab='', ylab='', zlab='', title='', cmp=default_colormap, save=False):
...
def plot_3d(u_z0, u_y0, u_x0, xin, yin, zin, u_z0_vec=None, u_y0_vec=None, u_x0_vec=None, xlab='', ylab='', zlab='', title='', cmp=default_colormap, streamline_density=1, streamline_width=0.5, streamline_color='w', save=False):
  ...
  if u_y0_vec is not None:
    plt.streamplot(x, z, u_y0_vec[0], u_y0_vec[1], density=streamline_density, color=streamline_color, arrowstyle='-', linewidth=streamline_width)
  # try:
...
def movie_3d(t, u_z0, u_y0, u_x0, xin, yin, zin, u_z0_vec=None, u_y0_vec=None, u_x0_vec=None, xlab='', ylab='', zlab='', title='', cmp=default_colormap, streamline_density=1, streamline_width=0.5, streamline_color='w', save=False):
