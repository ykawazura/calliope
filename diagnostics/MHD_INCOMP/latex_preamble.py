preamble = [ \
			...
			r'\DeclareFontFamily{OML}{txmi1}{}', 
			r'\DeclareFontShape{OML}{txmi1}{m}{it}{<->txmi1}{} ', 
			r'\DeclareSymbolFont{myletter}{OML}{txmi1}{m}{it}', 
			r'\DeclareMathSymbol{v}{\mathalpha}{myletter}{`v}', 
