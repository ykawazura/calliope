...
aaa_r_z0 = np.transpose(np.fromfile(input_dir+'out2d'+restart_num+'/aaa_r_z0.dat').reshape(nt_fld, nly, nlx)); aaa_r_z0 = np.transpose(aaa_r_z0, axes=(2, 1, 0))
aaa_r_x0 = np.transpose(np.fromfile(input_dir+'out2d'+restart_num+'/aaa_r_x0.dat').reshape(nt_fld, nlz, nly)); aaa_r_x0 = np.transpose(aaa_r_x0, axes=(2, 1, 0))
aaa_r_y0 = np.transpose(np.fromfile(input_dir+'out2d'+restart_num+'/aaa_r_y0.dat').reshape(nt_fld, nlz, nlx)); aaa_r_y0 = np.transpose(aaa_r_y0, axes=(2, 1, 0))
...
plot_3d(phi_r_z0[final_fld_idx,:,:], phi_r_y0[final_fld_idx,:,:], phi_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\Phi (t = %.2E)$' % tt_fld[final_fld_idx], cmp='RdBu_r', save=outdir+'phi.pdf')
plot_3d(omg_r_z0[final_fld_idx,:,:], omg_r_y0[final_fld_idx,:,:], omg_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\nbl_\+^2\Phi (t = %.2E)$' % tt_fld[final_fld_idx], cmp='RdBu_r', save=outdir+'omg.pdf')
plot_3d(psi_r_z0[final_fld_idx,:,:], psi_r_y0[final_fld_idx,:,:], psi_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\Psi (t = %.2E)$' % tt_fld[final_fld_idx], cmp='RdBu_r', save=outdir+'psi.pdf')
plot_3d(jpa_r_z0[final_fld_idx,:,:], jpa_r_y0[final_fld_idx,:,:], jpa_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\nbl_\+^2\Psi (t = %.2E)$' % tt_fld[final_fld_idx], cmp='RdBu_r', save=outdir+'jpa.pdf')
plot_3d(aaa_r_z0[final_fld_idx,:,:], aaa_r_y0[final_fld_idx,:,:], aaa_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$u_\| (t = %.2E)$' % tt_fld[final_fld_idx], cmp='RdBu_r', save=outdir+'aaa.pdf')
plot_3d(upe_r_z0[final_fld_idx,:,:], upe_r_y0[final_fld_idx,:,:], upe_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$|\bm{u}_\+| (t = %.2E)$' % tt_fld[final_fld_idx], cmp=parula_map, save=outdir+'upe.pdf')
plot_3d(bpe_r_z0[final_fld_idx,:,:], bpe_r_y0[final_fld_idx,:,:], bpe_r_x0[final_fld_idx,:,:], xx, yy, zz, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$|\delta\bm{B}_\+| (t = %.2E)$' % tt_fld[final_fld_idx], cmp=parula_map, save=outdir+'bpe.pdf')
...
if ismovie:
  ...
  bpe_r_x0 = np.sqrt(bx_r_x0**2 + by_r_x0**2)
  #^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^#
  movie_3d(tt_fld, phi_r_z0, phi_r_y0, phi_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\Phi$', cmp='RdBu_r', save=outdir+'phi_anim.gif')
  movie_3d(tt_fld, omg_r_z0, omg_r_y0, omg_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\nbl_\+^2\Phi$', cmp='RdBu_r', save=outdir+'omg_anim.gif')
  movie_3d(tt_fld, psi_r_z0, psi_r_y0, psi_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\Psi$', cmp='RdBu_r', save=outdir+'psi_anim.gif')
  movie_3d(tt_fld, jpa_r_z0, jpa_r_y0, jpa_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$\nbl_\+^2\Psi$', cmp='RdBu_r', save=outdir+'jpa_anim.gif')
  movie_3d(tt_fld, upe_r_z0, upe_r_y0, upe_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$|\bm{u}_\+|$', cmp=parula_map, save=outdir+'upe_anim.gif')
  movie_3d(tt_fld, bpe_r_z0, bpe_r_y0, bpe_r_x0, xx_fld, yy_fld, zz_fld, xlab=r'$x/L_\+$', ylab=r'$y/L_\+$', zlab='$'+zlab+'$', title=r'$|\delta\bm{B}_\+|$', cmp=parula_map, save=outdir+'bpe_anim.gif')
...
savemat(outdir + 'u_r' , {
                            ...
                            #
                            'aaa_r_z0' :aaa_r_z0[final_fld_idx,:,:]/np.sqrt(aaa2_sum[final_fld_idx]),
                            'aaa_r_x0' :aaa_r_x0[final_fld_idx,:,:]/np.sqrt(aaa2_sum[final_fld_idx]),
                            'aaa_r_y0' :aaa_r_y0[final_fld_idx,:,:]/np.sqrt(aaa2_sum[final_fld_idx]),
                          })
savemat(outdir + 'b_r' , {
                            'tt'       :tt[final_fld_idx],
